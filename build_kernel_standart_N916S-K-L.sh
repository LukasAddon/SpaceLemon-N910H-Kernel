...
BK=build_kernel
sed -i 's/\-Extended\-/\-Standart\-/g' arch/arm/configs/exynos5433-tre3caltelgt_defconfig
...
zip -r N916S-K-L-SpaceLemon-v${GETVER}-standart.zip ./
...
zip -r N916S-K-L-SpaceLemon-v${GETVER}-standart-no-root.zip ./
