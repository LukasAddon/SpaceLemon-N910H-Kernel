/*
 * max77849-muic.h - MUIC for the Maxim 77843
 *
...
#ifndef __MAX77849_MUIC_H__
#define __MAX77849_MUIC_H__

#define MUIC_DEV_NAME			"muic-max77849"
...
struct max77849_muic_data {
	...
	struct max77849_platform_data	*mfd_pdata;
...
/* max77849 muic register read/write related information defines. */

/* MAX77849 REGISTER ENABLE or DISABLE bit */
enum max77849_reg_bit_control {
	MAX77849_DISABLE_BIT		= 0,
	MAX77849_ENABLE_BIT,
};
...
#define CTRL2_CPEN1_LOWPWD0	((MAX77849_ENABLE_BIT << CTRL2_CPEN_SHIFT) | \
				(MAX77849_DISABLE_BIT << CTRL2_ADCLOWPWR_SHIFT))
#define CTRL2_CPEN0_LOWPWD1	((MAX77849_DISABLE_BIT << CTRL2_CPEN_SHIFT) | \
				(MAX77849_ENABLE_BIT << CTRL2_ADCLOWPWR_SHIFT))
...
/* MAX77849 MUIC Output of USB Charger Detection */
typedef enum {
...
enum max77849_reg_ctrl1_val {
	MAX77849_MUIC_CTRL1_ID_OPEN		= 0x0,
	MAX77849_MUIC_CTRL1_ID_BYPASS		= 0x1,
	MAX77849_MUIC_CTRL1_NO_BC_COMP_OFF	= 0x0,
	MAX77849_MUIC_CTRL1_NO_BC_COMP_ON	= 0x1,
	MAX77849_MUIC_CTRL1_COM_OPEN		= 0x00,
	MAX77849_MUIC_CTRL1_COM_USB		= 0x01,
	MAX77849_MUIC_CTRL1_COM_AUDIO		= 0x02,
	MAX77849_MUIC_CTRL1_COM_UART		= 0x03,
	MAX77849_MUIC_CTRL1_COM_USB_CP		= 0x04,
	MAX77849_MUIC_CTRL1_COM_UART_CP		= 0x05,
};

typedef enum {
	CTRL1_OPEN	= (MAX77849_MUIC_CTRL1_ID_OPEN << IDBEN_SHIFT) | \
			(MAX77849_MUIC_CTRL1_NO_BC_COMP_OFF << NOBCCOMP_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_OPEN << COMP2SW_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_OPEN << COMN1SW_SHIFT),
	CTRL1_USB	= (MAX77849_MUIC_CTRL1_ID_OPEN << IDBEN_SHIFT) | \
			(MAX77849_MUIC_CTRL1_NO_BC_COMP_OFF << NOBCCOMP_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_USB << COMP2SW_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_USB << COMN1SW_SHIFT),
	CTRL1_AUDIO	= (MAX77849_MUIC_CTRL1_ID_OPEN << IDBEN_SHIFT) | \
			(MAX77849_MUIC_CTRL1_NO_BC_COMP_OFF << NOBCCOMP_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_AUDIO << COMP2SW_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_AUDIO << COMN1SW_SHIFT),
	CTRL1_UART	= (MAX77849_MUIC_CTRL1_ID_OPEN << IDBEN_SHIFT) | \
			(MAX77849_MUIC_CTRL1_NO_BC_COMP_OFF << NOBCCOMP_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_UART << COMP2SW_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_UART << COMN1SW_SHIFT),
	CTRL1_USB_CP	= (MAX77849_MUIC_CTRL1_ID_OPEN << IDBEN_SHIFT) | \
			(MAX77849_MUIC_CTRL1_NO_BC_COMP_OFF << NOBCCOMP_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_USB_CP << COMP2SW_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_USB_CP << COMN1SW_SHIFT),
	CTRL1_UART_CP	= (MAX77849_MUIC_CTRL1_ID_OPEN << IDBEN_SHIFT) | \
			(MAX77849_MUIC_CTRL1_NO_BC_COMP_OFF << NOBCCOMP_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_UART_CP << COMP2SW_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_UART_CP << COMN1SW_SHIFT),
	CTRL1_USB_DOCK	= (MAX77849_MUIC_CTRL1_ID_OPEN << IDBEN_SHIFT) | \
			(MAX77849_MUIC_CTRL1_NO_BC_COMP_ON << NOBCCOMP_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_USB << COMP2SW_SHIFT) | \
			(MAX77849_MUIC_CTRL1_COM_USB << COMN1SW_SHIFT),
} max77849_reg_ctrl1_t;

enum {
	MAX77849_MUIC_CTRL4_ADCMODE_ALWAYS_ON		= 0x00,
	MAX77849_MUIC_CTRL4_ADCMODE_ALWAYS_ON_1M_MON	= 0x01,
	MAX77849_MUIC_CTRL4_ADCMODE_ONE_SHOT		= 0x02,
	MAX77849_MUIC_CTRL4_ADCMODE_2S_PULSE		= 0x03
};

extern struct device *switch_device;

#endif /* __MAX77849_MUIC_H__ */
