...
typedef int (*sm_hal_fled_strobe)(struct sm_fled_info *info, int turn_way);
...
struct sm_fled_hal {
	...
	sm_hal_fled_strobe fled_strobe;
 ...
 * fled_info->hal->fled_set_flash_current(fled_info, 150, 200);
 */
