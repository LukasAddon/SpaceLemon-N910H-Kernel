...
#define EXYNOS5_ARM_INTR_SPREAD_ENABLE			EXYNOS_PMUREG(0x0100)
#define EXYNOS5_ARM_INTR_SPREAD_USE_STANDBYWFI		EXYNOS_PMUREG(0x0104)
#define EXYNOS5_KFC_INTR_SPREAD_ENABLE			EXYNOS_PMUREG(0x0110)
#define EXYNOS5_KFC_INTR_SPREAD_USE_STANDBYWFI		EXYNOS_PMUREG(0x0114)
#define EXYNOS5_UP_SCHEDULER				EXYNOS_PMUREG(0x0120)

#define ENABLE_EAGLE_CPU			BIT(0)
#define ENABLE_KFC_CPU				BIT(1)
...
#define EXYNOS_USE_PROLOGNED_LOGIC_RESET	(1 << 12)

/* New register at EXYNOS5430 */
#define EXYNOS_CENTRAL_SEQ_MIF_CONFIGURATION	EXYNOS_PMUREG(0x0240)
#define EXYNOS_CENTRAL_SEQ_MIF_OPTION		EXYNOS_PMUREG(0x0248)
/* end */
...
#define EXYNOS_ARM_WDTRESET			(1 << 23)
#define EXYNOS_KFC_WDTRESET			(1 << 24)
#define EXYNOS_SSS_WDTRESET			(1 << 26)
#define EXYNOS_A5IS_WDTRESET			(1 << 27)
...
#define S5P_MIPI_DPHY_CONTROL(n)		((soc_is_exynos5250() || soc_is_exynos5430() || soc_is_exynos5433()) ? \
...
#define EXYNOS_EN_NONRET_RESET			(1 << 1)
...
#define EXYNOS_PMU_SPARE3			EXYNOS_PMUREG(0x090C)
...
/* New register at EXYNOS5430 */
#define EXYNOS_ARM_CON_OPTION			EXYNOS_PMUREG(0x0A04)
#define EXYNOS_BURNIN_CTRL			EXYNOS_PMUREG(0x0A08)
...
#define EXYNOS_ARM_CORE0_RESET			EXYNOS_PMUREG(0x200C)
...
#define EXYNOS_ARM_CORE2_STATUS			EXYNOS_PMUREG(0x2104)
#define EXYNOS_ARM_CORE2_OPTION			EXYNOS_PMUREG(0x2108)
#define EXYNOS_ARM_CORE3_CONFIGURATION		EXYNOS_PMUREG(0x2180)
#define EXYNOS_ARM_CORE3_STATUS			EXYNOS_PMUREG(0x2184)
#define EXYNOS_ARM_CORE3_OPTION			EXYNOS_PMUREG(0x2188)
...
#define EXYNOS_KFC_CORE1_CONFIGURATION		EXYNOS_PMUREG(0x2280)
#define EXYNOS_KFC_CORE1_STATUS			EXYNOS_PMUREG(0x2284)
#define EXYNOS_KFC_CORE1_OPTION			EXYNOS_PMUREG(0x2288)
#define EXYNOS_KFC_CORE2_CONFIGURATION		EXYNOS_PMUREG(0x2300)
#define EXYNOS_KFC_CORE2_STATUS			EXYNOS_PMUREG(0x2304)
#define EXYNOS_KFC_CORE2_OPTION			EXYNOS_PMUREG(0x2308)
#define EXYNOS_KFC_CORE3_CONFIGURATION		EXYNOS_PMUREG(0x2380)
#define EXYNOS_KFC_CORE3_STATUS			EXYNOS_PMUREG(0x2384)
#define EXYNOS_KFC_CORE3_OPTION			EXYNOS_PMUREG(0x2388)
...
#define EXYNOS_ARM_CORE_OPTION(_nr)		(EXYNOS_ARM_CORE0_OPTION \
						+ ((_nr) * 0x80))
#define EXYNOS_ARM_CORE_RESET(_nr)		(EXYNOS_ARM_CORE0_RESET \
						+ ((_nr) * 0x80))
...
#define EXYNOS_CORE_PWR_EN				(0xF)
#define EXYNOS_CORE_INIT_WAKEUP_FROM_LOWPWR		(0xF << 16)
#define EXYNOS_L2_PWR_EN				(0x7)

#define EXYNOS_L2_PWR_EN				(0x7)
#define EXYNOS_PWR_EN					(0xF)
...
#define EXYNOS5_USE_STANDBYWFI_ARM_CORE2		(1 << 18)
#define EXYNOS5_USE_STANDBYWFI_ARM_CORE3		(1 << 19)
#define EXYNOS5_USE_STANDBYWFI_KFC_CORE0		(1 << 20)
#define EXYNOS5_USE_STANDBYWFI_KFC_CORE1		(1 << 21)
#define EXYNOS5_USE_STANDBYWFI_KFC_CORE2		(1 << 22)
#define EXYNOS5_USE_STANDBYWFI_KFC_CORE3		(1 << 23)
#define EXYNOS5_USE_STANDBYWFE_ARM_CORE0		(1 << 24)
#define EXYNOS5_USE_STANDBYWFE_ARM_CORE1		(1 << 25)
#define EXYNOS5_USE_STANDBYWFE_ARM_CORE2		(1 << 26)
#define EXYNOS5_USE_STANDBYWFE_ARM_CORE3		(1 << 27)
#define EXYNOS5_USE_STANDBYWFE_KFC_CORE0		(1 << 28)
#define EXYNOS5_USE_STANDBYWFE_KFC_CORE1		(1 << 29)
#define EXYNOS5_USE_STANDBYWFE_KFC_CORE2		(1 << 30)
#define EXYNOS5_USE_STANDBYWFE_KFC_CORE3		(1 << 31)

#define EXYNOS5_USE_STANDBY_WFI_ALL			(EXYNOS5_USE_STANDBYWFI_ARM_CORE0  \
							| EXYNOS5_USE_STANDBYWFI_ARM_CORE1 \
							| EXYNOS5_USE_STANDBYWFI_ARM_CORE2 \
							| EXYNOS5_USE_STANDBYWFI_ARM_CORE3 \
							| EXYNOS5_USE_STANDBYWFI_KFC_CORE0 \
							| EXYNOS5_USE_STANDBYWFI_KFC_CORE1 \
							| EXYNOS5_USE_STANDBYWFI_KFC_CORE2 \
							| EXYNOS5_USE_STANDBYWFI_KFC_CORE3)
/* Only for EXYNOS4XXX */
...
/* Only for EXYNOS5410 */
#define EXYNOS54XX_LPI_MASK0					EXYNOS_PMUREG(0x0004)
#define EXYNOS54XX_LPI_MASK1					EXYNOS_PMUREG(0x0008)
#define EXYNOS54XX_LPI_MASK2					EXYNOS_PMUREG(0x000C)
...
#define EXYNOS54XX_ARM_CORE2_SYS_PWR_REG			EXYNOS_PMUREG(0x1020)
#define EXYNOS54XX_DIS_IRQ_ARM_CORE2_LOCAL_SYS_PWR_REG		EXYNOS_PMUREG(0x1024)
#define EXYNOS54XX_DIS_IRQ_ARM_CORE2_CENTRAL_SYS_PWR_REG	EXYNOS_PMUREG(0x1028)
#define EXYNOS54XX_ARM_CORE3_SYS_PWR_REG			EXYNOS_PMUREG(0x1030)
#define EXYNOS54XX_DIS_IRQ_ARM_CORE3_LOCAL_SYS_PWR_REG		EXYNOS_PMUREG(0x1034)
#define EXYNOS54XX_DIS_IRQ_ARM_CORE3_CENTRAL_SYS_PWR_REG	EXYNOS_PMUREG(0x1038)
#define EXYNOS54XX_KFC_CORE0_SYS_PWR_REG			EXYNOS_PMUREG(0x1040)
#define EXYNOS54XX_DIS_IRQ_KFC_CORE0_LOCAL_SYS_PWR_REG		EXYNOS_PMUREG(0x1044)
#define EXYNOS54XX_DIS_IRQ_KFC_CORE0_CENTRAL_SYS_PWR_REG	EXYNOS_PMUREG(0x1048)
#define EXYNOS54XX_KFC_CORE1_SYS_PWR_REG			EXYNOS_PMUREG(0x1050)
#define EXYNOS54XX_DIS_IRQ_KFC_CORE1_LOCAL_SYS_PWR_REG		EXYNOS_PMUREG(0x1054)
#define EXYNOS54XX_DIS_IRQ_KFC_CORE1_CENTRAL_SYS_PWR_REG	EXYNOS_PMUREG(0x1058)
#define EXYNOS54XX_KFC_CORE2_SYS_PWR_REG			EXYNOS_PMUREG(0x1060)
#define EXYNOS54XX_DIS_IRQ_KFC_CORE2_LOCAL_SYS_PWR_REG		EXYNOS_PMUREG(0x1064)
#define EXYNOS54XX_DIS_IRQ_KFC_CORE2_CENTRAL_SYS_PWR_REG	EXYNOS_PMUREG(0x1068)
#define EXYNOS54XX_KFC_CORE3_SYS_PWR_REG			EXYNOS_PMUREG(0x1070)
#define EXYNOS54XX_DIS_IRQ_KFC_CORE3_LOCAL_SYS_PWR_REG		EXYNOS_PMUREG(0x1074)
#define EXYNOS54XX_DIS_IRQ_KFC_CORE3_CENTRAL_SYS_PWR_REG	EXYNOS_PMUREG(0x1078)
#define EXYNOS54XX_ISP_ARM_SYS_PWR_REG				EXYNOS_PMUREG(0x1090)
#define EXYNOS54XX_DIS_IRQ_ISP_ARM_LOCAL_SYS_PWR_REG		EXYNOS_PMUREG(0x1094)
#define EXYNOS54XX_DIS_IRQ_ISP_ARM_CENTRAL_SYS_PWR_REG		EXYNOS_PMUREG(0x1098)
#define EXYNOS54XX_ARM_COMMON_SYS_PWR_REG			EXYNOS_PMUREG(0x10A0)
#define EXYNOS54XX_KFC_COMMON_SYS_PWR_REG			EXYNOS_PMUREG(0x10B0)
#define EXYNOS54XX_KFC_L2_SYS_PWR_REG				EXYNOS_PMUREG(0x10D0)
#define EXYNOS54XX_DPLL_SYSCLK_SYS_PWR_REG			EXYNOS_PMUREG(0x1158)
#define EXYNOS54XX_IPLL_SYSCLK_SYS_PWR_REG			EXYNOS_PMUREG(0x115C)
#define EXYNOS54XX_KPLL_SYSCLK_SYS_PWR_REG			EXYNOS_PMUREG(0x1160)
...
#define EXYNOS5410_PAD_RETENTION_GPIO_SYS_PWR_REG		EXYNOS_PMUREG(0x1210)
#define EXYNOS54XX_PAD_RETENTION_UART_SYS_PWR_REG		EXYNOS_PMUREG(0x1214)
#define EXYNOS54XX_PAD_RETENTION_MMC0_SYS_PWR_REG		EXYNOS_PMUREG(0x1218)
#define EXYNOS54XX_PAD_RETENTION_MMC1_SYS_PWR_REG		EXYNOS_PMUREG(0x121C)
#define EXYNOS54XX_PAD_RETENTION_MMC2_SYS_PWR_REG		EXYNOS_PMUREG(0x1220)
#define EXYNOS54XX_PAD_RETENTION_HSI_SYS_PWR_REG		EXYNOS_PMUREG(0x1224)
#define EXYNOS54XX_PAD_RETENTION_EBIA_SYS_PWR_REG		EXYNOS_PMUREG(0x1228)
#define EXYNOS54XX_PAD_RETENTION_EBIB_SYS_PWR_REG		EXYNOS_PMUREG(0x122C)
#define EXYNOS54XX_PAD_RETENTION_SPI_SYS_PWR_REG		EXYNOS_PMUREG(0x1230)
#define EXYNOS54XX_PAD_RETENTION_GPIO_COREBLK_SYS_PWR_REG	EXYNOS_PMUREG(0x1234)
...
#define EXYNOS54XX_ARM_COMMON_STATUS				EXYNOS_PMUREG(0x2504)
#define EXYNOS54XX_ARM_COMMON_OPTION				EXYNOS_PMUREG(0x2508)
#define EXYNOS54XX_KFC_COMMON_STATUS				EXYNOS_PMUREG(0x2584)
#define EXYNOS54XX_KFC_COMMON_OPTION				EXYNOS_PMUREG(0x2588)
#define EXYNOS5410_LOGIC_RESET_DURATION3			EXYNOS_PMUREG(0x2D1C)

#define EXYNOS54XX_PAD_RET_GPIO_OPTION			EXYNOS_PMUREG(0x30C8)
#define EXYNOS54XX_PAD_RET_UART_OPTION			EXYNOS_PMUREG(0x30E8)
#define EXYNOS54XX_PAD_RET_MMCA_OPTION			EXYNOS_PMUREG(0x3108)
#define EXYNOS54XX_PAD_RET_MMCB_OPTION			EXYNOS_PMUREG(0x3128)
#define EXYNOS54XX_PAD_RET_MMCC_OPTION			EXYNOS_PMUREG(0x3148)
#define EXYNOS54XX_PAD_RET_HSI_OPTION			EXYNOS_PMUREG(0x3168)
#define EXYNOS54XX_PAD_RET_SPI_OPTION			EXYNOS_PMUREG(0x31C8)
...
/* Only for EXYNOS5430 */
#define EXYNOS5430_WAKEUP_STAT					EXYNOS_PMUREG(0x0600)
#define EXYNOS5430_WAKEUP_STAT1					EXYNOS_PMUREG(0x0604)
#define EXYNOS5430_WAKEUP_STAT2					EXYNOS_PMUREG(0x0608)
#define EXYNOS5430_EINT_WAKEUP_MASK				EXYNOS_PMUREG(0x060C)
#define EXYNOS5430_WAKEUP_MASK					EXYNOS_PMUREG(0x0610)
#define EXYNOS5430_WAKEUP_MASK1					EXYNOS_PMUREG(0x0614)
#define EXYNOS5430_WAKEUP_MASK2					EXYNOS_PMUREG(0x0618)
#define EXYNOS5430_WAKEUP_INTERRUPT				EXYNOS_PMUREG(0x061C)
#define EXYNOS5430_WAKEUP_STAT_MIF				EXYNOS_PMUREG(0x0620)
#define EXYNOS5430_EINT_WAKEUP_MASK_MIF				EXYNOS_PMUREG(0x0624)
#define EXYNOS5430_WAKEUP_MASK_MIF				EXYNOS_PMUREG(0x0628)

#define EXYNOS5430_LLI_PHY_CON					EXYNOS_PMUREG(0x0720)
#define EXYNOS5430_UFS_PHY_CON					EXYNOS_PMUREG(0x0724)

#define EXYNOS5430_BB_CON0					EXYNOS_PMUREG(0x0780)
#define EXYNOS5430_BB_CON1					EXYNOS_PMUREG(0x0784)
#define EXYNOS5430_BB_CON2					EXYNOS_PMUREG(0x0788)
#define EXYNOS5430_BB_CON3					EXYNOS_PMUREG(0x078C)
#define EXYNOS5430_BB_CON4					EXYNOS_PMUREG(0x0790)
#define EXYNOS5430_BB_CON5					EXYNOS_PMUREG(0x0794)

#define EXYNOS5430_DREX_CALN0					EXYNOS_PMUREG(0x09A0)
#define EXYNOS5430_DREX_CALN1					EXYNOS_PMUREG(0x09A4)
#define EXYNOS5430_DREX_CALN2					EXYNOS_PMUREG(0x09A8)


#define EXYNOS5430_EAGLE_NONCPU_SYS_PWR_REG			EXYNOS_PMUREG(0x1080)
#define EXYNOS5430_KFC_NONCPU_SYS_PWR_REG			EXYNOS_PMUREG(0x1084)
#define EXYNOS5430_A5IS_SYS_PWR_REG				EXYNOS_PMUREG(0x10B0)
#define EXYNOS5430_DIS_IRQ_A5IS_LOCAL_SYS_PWR_REG		EXYNOS_PMUREG(0x10B4)
#define EXYNOS5430_DIS_IRQ_A5IS_CENTRAL_SYS_PWR_REG		EXYNOS_PMUREG(0x10B8)
#define EXYNOS5430_KFC_L2_SYS_PWR_REG				EXYNOS_PMUREG(0x10C4)
#define EXYNOS5430_CLKSTOP_CMU_TOP_SYS_PWR_REG			EXYNOS_PMUREG(0x1100)
#define EXYNOS5430_CLKRUN_CMU_TOP_SYS_PWR_REG			EXYNOS_PMUREG(0x1104)
#define EXYNOS5430_RESET_CMU_TOP_SYS_PWR_REG			EXYNOS_PMUREG(0x110C)
#define EXYNOS5430_RESET_CPUCLKSTOP_SYS_PWR_REG			EXYNOS_PMUREG(0x111C)
#define EXYNOS5430_CLKSTOP_CMU_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x1120)
#define EXYNOS5430_CLKRUN_CMU_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x1124)
#define EXYNOS5430_RESET_CMU_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x112C)
#define EXYNOS5430_DISABLE_PLL_CMU_TOP_SYS_PWR_REG		EXYNOS_PMUREG(0x1140)
#define EXYNOS5430_DISABLE_PLL_AUD_PLL_SYS_PWR_REG		EXYNOS_PMUREG(0x1144)
#define EXYNOS5430_DISABLE_PLL_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x1160)
#define EXYNOS5430_TOP_BUS_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x1190)
#define EXYNOS5430_TOP_RETENTION_MIF_SYS_PWR_REG		EXYNOS_PMUREG(0x1194)
#define EXYNOS5430_TOP_PWR_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x1198)
#define EXYNOS5430_SLEEP_RESET_SYS_PWR_REG			EXYNOS_PMUREG(0x11A8)
#define EXYNOS5430_LOGIC_RESET_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x11B0)
#define EXYNOS5430_OSCCLK_GATE_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x11B4)
#define EXYNOS5430_SLEEP_RESET_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x11B8)
#define EXYNOS5430_MEMORY_TOP_SYS_PWR_REG			EXYNOS_PMUREG(0x11C0)
#define EXYNOS5430_PAD_RETENTION_JTAG_SYS_PWR_REG		EXYNOS_PMUREG(0x1208)
#define EXYNOS5430_PAD_RETENTION_TOP_SYS_PWR_REG		EXYNOS_PMUREG(0x1220)
#define EXYNOS5430_PAD_RETENTION_UART_SYS_PWR_REG		EXYNOS_PMUREG(0x1224)
#define EXYNOS5430_PAD_RETENTION_EBIA_SYS_PWR_REG		EXYNOS_PMUREG(0x1230)
#define EXYNOS5430_PAD_RETENTION_EBIB_SYS_PWR_REG		EXYNOS_PMUREG(0x1234)
#define EXYNOS5430_PAD_RETENTION_SPI_SYS_PWR_REG		EXYNOS_PMUREG(0x1238)
#define EXYNOS5430_PAD_RETENTION_MIF_SYS_PWR_REG		EXYNOS_PMUREG(0x123C)
#define EXYNOS5430_PAD_RETENTION_USBXTI_SYS_PWR_REG		EXYNOS_PMUREG(0x1244)
#define EXYNOS5430_PAD_RETENTION_BOOTLDO_SYS_PWR_REG		EXYNOS_PMUREG(0x1248)
#define EXYNOS5430_PAD_ISOLATION_MIF_SYS_PWR_REG		EXYNOS_PMUREG(0x1250)
#define EXYNOS5430_PAD_RETENTION_FSYSGENIO_SYS_PWR_REG		EXYNOS_PMUREG(0x1254)
#define EXYNOS5430_XXTI26_SYS_PWR_REG				EXYNOS_PMUREG(0x1288)
#define EXYNOS5430_GPIO_MODE_FSYS_SYS_PWR_REG			EXYNOS_PMUREG(0x1304)
#define EXYNOS5430_GPIO_MODE_MIF_SYS_PWR_REG			EXYNOS_PMUREG(0x1320)
#define EXYNOS5430_GPIO_MODE_AUD_SYS_PWR_REG			EXYNOS_PMUREG(0x1340)
#define EXYNOS5430_GSCL_SYS_PWR_REG				EXYNOS_PMUREG(0x1400)
#define EXYNOS5430_CAM0_SYS_PWR_REG				EXYNOS_PMUREG(0x1404)
#define EXYNOS5430_MSCL_SYS_PWR_REG				EXYNOS_PMUREG(0x1408)
#define EXYNOS5430_G3D_SYS_PWR_REG				EXYNOS_PMUREG(0x140C)
#define EXYNOS5430_DISP_SYS_PWR_REG				EXYNOS_PMUREG(0x1410)
#define EXYNOS5430_CAM1_SYS_PWR_REG				EXYNOS_PMUREG(0x1414)
#define EXYNOS5430_AUD_SYS_PWR_REG				EXYNOS_PMUREG(0x1418)
#define EXYNOS5430_FSYS_SYS_PWR_REG				EXYNOS_PMUREG(0x141C)
#define EXYNOS5430_BUS2_SYS_PWR_REG				EXYNOS_PMUREG(0x1420)
#define EXYNOS5430_G2D_SYS_PWR_REG				EXYNOS_PMUREG(0x1424)
#define EXYNOS5430_ISP_SYS_PWR_REG				EXYNOS_PMUREG(0x1428)
#define EXYNOS5430_MFC0_SYS_PWR_REG				EXYNOS_PMUREG(0x1430)
#define EXYNOS5430_MFC1_SYS_PWR_REG				EXYNOS_PMUREG(0x1434)
#define EXYNOS5430_HEVC_SYS_PWR_REG				EXYNOS_PMUREG(0x1438)
#define EXYNOS5430_DISABLE_PLL_CMU_GSCL_SYS_PWR_REG		EXYNOS_PMUREG(0x14C0)
#define EXYNOS5430_DISABLE_PLL_CMU_CAM0_SYS_PWR_REG		EXYNOS_PMUREG(0x14C4)
#define EXYNOS5430_DISABLE_PLL_CMU_MSCL_SYS_PWR_REG		EXYNOS_PMUREG(0x14C8)
#define EXYNOS5430_DISABLE_PLL_CMU_G3D_SYS_PWR_REG		EXYNOS_PMUREG(0x14CC)
#define EXYNOS5430_DISABLE_PLL_CMU_DISP_SYS_PWR_REG		EXYNOS_PMUREG(0x14D0)
#define EXYNOS5430_DISABLE_PLL_CMU_CAM1_SYS_PWR_REG		EXYNOS_PMUREG(0x14D4)
#define EXYNOS5430_DISABLE_PLL_CMU_AUD_SYS_PWR_REG		EXYNOS_PMUREG(0x14D8)
#define EXYNOS5430_DISABLE_PLL_CMU_FSYS_SYS_PWR_REG		EXYNOS_PMUREG(0x14DC)
#define EXYNOS5430_DISABLE_PLL_CMU_BUS2_SYS_PWR_REG		EXYNOS_PMUREG(0x14E0)
#define EXYNOS5430_DISABLE_PLL_CMU_G2D_SYS_PWR_REG		EXYNOS_PMUREG(0x14E4)
#define EXYNOS5430_DISABLE_PLL_CMU_ISP_SYS_PWR_REG		EXYNOS_PMUREG(0x14E8)
#define EXYNOS5430_DISABLE_PLL_CMU_MFC0_SYS_PWR_REG		EXYNOS_PMUREG(0x14F0)
#define EXYNOS5430_DISABLE_PLL_CMU_MFC1_SYS_PWR_REG		EXYNOS_PMUREG(0x14F4)
#define EXYNOS5430_DISABLE_PLL_CMU_HEVC_SYS_PWR_REG		EXYNOS_PMUREG(0x14F8)
#define EXYNOS5430_RESET_CMU_FSYS_SYS_PWR_REG			EXYNOS_PMUREG(0x159C)
#define EXYNOS5430_RESET_CMU_BUS2_SYS_PWR_REG			EXYNOS_PMUREG(0x15A0)
#define EXYNOS5430_RESET_SLEEP_FSYS_SYS_PWR_REG			EXYNOS_PMUREG(0x15DC)
#define EXYNOS5430_RESET_SLEEP_BUS2_SYS_PWR_REG			EXYNOS_PMUREG(0x15E0)

#define EXYNOS5430_EAGLE_NONCPU_CONFIGURATION			EXYNOS_PMUREG(0x2400)
#define EXYNOS5430_EAGLE_NONCPU_STATUS				EXYNOS_PMUREG(0x2404)
#define EXYNOS5430_EAGLE_NONCPU_OPTION				EXYNOS_PMUREG(0x2408)
#define EXYNOS5430_KFC_NONCPU_CONFIGURATION			EXYNOS_PMUREG(0x2420)
#define EXYNOS5430_KFC_NONCPU_STATUS				EXYNOS_PMUREG(0x2424)
#define EXYNOS5430_KFC_NONCPU_OPTION				EXYNOS_PMUREG(0x2428)
#define EXYNOS5430_EAGLE_CPUSEQ_CONFIGURATION			EXYNOS_PMUREG(0x2480)
#define EXYNOS5430_EAGLE_CPUSEQ_STATUS				EXYNOS_PMUREG(0x2484)
#define EXYNOS5430_EAGLE_CPUSEQ_OPTION				EXYNOS_PMUREG(0x2488)
#define EXYNOS5430_KFC_CPUSEQ_CONFIGURATION			EXYNOS_PMUREG(0x24A0)
#define EXYNOS5430_KFC_CPUSEQ_STATUS				EXYNOS_PMUREG(0x24A4)
#define EXYNOS5430_KFC_CPUSEQ_OPTION				EXYNOS_PMUREG(0x24A8)
#define EXYNOS5430_A5IS_CONFIGURATION				EXYNOS_PMUREG(0x2580)
#define EXYNOS5430_A5IS_STATUS					EXYNOS_PMUREG(0x2584)
#define EXYNOS5430_A5IS_OPTION					EXYNOS_PMUREG(0x2588)
#define EXYNOS5430_EAGLE_L2_STATUS				EXYNOS_PMUREG(0x2604)
#define EXYNOS5430_KFC_L2_STATUS				EXYNOS_PMUREG(0x2624)
#define EXYNOS5430_OSC_DURATION					EXYNOS_PMUREG(0x2D3C)

#define EXYNOS5430_PAD_RETENTION_MMC2_OPTION			EXYNOS_PMUREG(0x30C8)
#define EXYNOS5430_PAD_RETENTION_TOP_OPTION			EXYNOS_PMUREG(0x3108)
#define EXYNOS5430_PAD_RETENTION_UART_OPTION			EXYNOS_PMUREG(0x3128)
#define EXYNOS5430_PAD_RETENTION_MMC0_OPTION			EXYNOS_PMUREG(0x3148)
#define EXYNOS5430_PAD_RETENTION_MMC1_OPTION			EXYNOS_PMUREG(0x3168)
#define EXYNOS5430_PAD_RETENTION_EBIA_OPTION			EXYNOS_PMUREG(0x3188)
#define EXYNOS5430_PAD_RETENTION_EBIB_OPTION			EXYNOS_PMUREG(0x31A8)
#define EXYNOS5430_PAD_RETENTION_SPI_OPTION			EXYNOS_PMUREG(0x31C8)
#define EXYNOS5430_PAD_RETENTION_MIF_OPTION			EXYNOS_PMUREG(0x31E8)
#define EXYNOS5430_PAD_RETENTION_USBXTI_OPTION			EXYNOS_PMUREG(0x3228)
#define EXYNOS5430_PAD_RETENTION_BOOTLDO_OPTION			EXYNOS_PMUREG(0x3248)
#define EXYNOS5430_PAD_RETENTION_UFS_OPTION			EXYNOS_PMUREG(0x3268)
#define EXYNOS5430_PAD_RETENTION_FSYSGENIO_OPTION		EXYNOS_PMUREG(0x32A8)
#define AUTOMATIC_WAKEUP					BIT(29)

#define EXYNOS5430_PS_HOLD_CONTROL				EXYNOS_PMUREG(0x330C)

#define EXYNOS5430_GSCL_CONFIGURATION				EXYNOS_PMUREG(0x4000)
#define EXYNOS5430_GSCL_STATUS					EXYNOS_PMUREG(0x4004)
#define EXYNOS5430_GSCL_OPTION					EXYNOS_PMUREG(0x4008)
#define EXYNOS5430_CAM0_CONFIGURATION				EXYNOS_PMUREG(0x4020)
#define EXYNOS5430_CAM0_STATUS					EXYNOS_PMUREG(0x4024)
#define EXYNOS5430_CAM0_OPTION					EXYNOS_PMUREG(0x4028)
#define EXYNOS5430_MSCL_CONFIGURATION				EXYNOS_PMUREG(0x4040)
#define EXYNOS5430_MSCL_STATUS					EXYNOS_PMUREG(0x4044)
#define EXYNOS5430_MSCL_OPTION					EXYNOS_PMUREG(0x4048)
#define EXYNOS5430_G3D_CONFIGURATION				EXYNOS_PMUREG(0x4060)
#define EXYNOS5430_G3D_STATUS					EXYNOS_PMUREG(0x4064)
#define EXYNOS5430_G3D_OPTION					EXYNOS_PMUREG(0x4068)
#define EXYNOS5430_DISP_CONFIGURATION				EXYNOS_PMUREG(0x4080)
#define EXYNOS5430_DISP_STATUS					EXYNOS_PMUREG(0x4084)
#define EXYNOS5430_DISP_OPTION					EXYNOS_PMUREG(0x4088)
#define EXYNOS5430_CAM1_CONFIGURATION				EXYNOS_PMUREG(0x40A0)
#define EXYNOS5430_CAM1_STATUS					EXYNOS_PMUREG(0x40A4)
#define EXYNOS5430_CAM1_OPTION					EXYNOS_PMUREG(0x40A8)
#define EXYNOS5430_AUD_CONFIGURATION				EXYNOS_PMUREG(0x40C0)
#define EXYNOS5430_AUD_STATUS					EXYNOS_PMUREG(0x40C4)
#define EXYNOS5430_AUD_OPTION					EXYNOS_PMUREG(0x40C8)
#define EXYNOS5430_FSYS_CONFIGURATION				EXYNOS_PMUREG(0x40E0)
#define EXYNOS5430_FSYS_STATUS					EXYNOS_PMUREG(0x40E4)
#define EXYNOS5430_FSYS_OPTION					EXYNOS_PMUREG(0x40E8)
#define EXYNOS5430_BUS2_CONFIGURATION				EXYNOS_PMUREG(0x4100)
#define EXYNOS5430_BUS2_STATUS					EXYNOS_PMUREG(0x4104)
#define EXYNOS5430_BUS2_OPTION					EXYNOS_PMUREG(0x4108)
#define EXYNOS5430_G2D_CONFIGURATION				EXYNOS_PMUREG(0x4120)
#define EXYNOS5430_G2D_STATUS					EXYNOS_PMUREG(0x4124)
#define EXYNOS5430_G2D_OPTION					EXYNOS_PMUREG(0x4128)
#define EXYNOS5430_ISP_CONFIGURATION				EXYNOS_PMUREG(0x4140)
#define EXYNOS5430_ISP_STATUS					EXYNOS_PMUREG(0x4144)
#define EXYNOS5430_ISP_OPTION					EXYNOS_PMUREG(0x4148)
#define EXYNOS5430_MFC0_CONFIGURATION				EXYNOS_PMUREG(0x4180)
#define EXYNOS5430_MFC0_STATUS					EXYNOS_PMUREG(0x4184)
#define EXYNOS5430_MFC0_OPTION					EXYNOS_PMUREG(0x4188)
#define EXYNOS5430_MFC1_CONFIGURATION				EXYNOS_PMUREG(0x41A0)
#define EXYNOS5430_MFC1_STATUS					EXYNOS_PMUREG(0x41A4)
#define EXYNOS5430_MFC1_OPTION					EXYNOS_PMUREG(0x41A8)
#define EXYNOS5430_HEVC_CONFIGURATION				EXYNOS_PMUREG(0x41C0)
#define EXYNOS5430_HEVC_STATUS					EXYNOS_PMUREG(0x41C4)
#define EXYNOS5430_HEVC_OPTION					EXYNOS_PMUREG(0x41C8)
#define EXYNOS5430_PMU_SYNC_CTRL				EXYNOS_PMUREG(0x0020)

#define EXYNOS_NONCPU_CONFIGURATION(_nr)			(EXYNOS5430_EAGLE_NONCPU_CONFIGURATION \
								 + ((_nr) * 0x20))

#define EXYNOS_NONCPU_STATUS(_nr)				(EXYNOS5430_EAGLE_NONCPU_STATUS \
								 + ((_nr) * 0x20))
#define EXYNOS5430_PMU_LPI_CAM0_REG(x)				(EXYNOS5430_VA_PMU_LPI_CAM0 + (x))
#define EXYNOS5430_LPI_MASK_CAM0_BUSMASTER			EXYNOS5430_PMU_LPI_CAM0_REG(0x0000)
#define EXYNOS5430_LPI_MASK_CAM0_BUSMASTER_FIMC_LITE_A		(1 << 0)
#define EXYNOS5430_LPI_MASK_CAM0_BUSMASTER_FIMC_LITE_B		(1 << 1)
#define EXYNOS5430_LPI_MASK_CAM0_BUSMASTER_FIMC_LITE_D		(1 << 2)
#define EXYNOS5430_LPI_MASK_CAM0_BUSMASTER_FIMC_3AA_0		(1 << 3)
#define EXYNOS5430_LPI_MASK_CAM0_BUSMASTER_FIMC_3AA_1		(1 << 4)
#define EXYNOS5430_LPI_MASK_CAM0_BUSMASTER_ALL			(0x1F)
#define EXYNOS5430_LPI_MASK_CAM0_ASYNCBRIDGE			EXYNOS5430_PMU_LPI_CAM0_REG(0x0020)
#define EXYNOS5430_LPI_MASK_CAM0_ASYNCBRIDGE_CAM1_CAM0		(1 << 0)
#define EXYNOS5430_LPI_MASK_CAM0_ASYNCBRIDGE_ALL		(0x1)
#define EXYNOS5430_LPI_MASK_CAM0_NOCBUS				EXYNOS5430_PMU_LPI_CAM0_REG(0x0040)
#define EXYNOS5430_LPI_MASK_CAM0_NOCBUS_D			(1 << 0)
#define EXYNOS5430_LPI_MASK_CAM0_NOCBUS_P			(1 << 1)
#define EXYNOS5430_LPI_MASK_CAM0_NOCBUS_ALL			(0x3)

#define EXYNOS5430_PMU_LPI_CAM1_REG(x)				(EXYNOS5430_VA_PMU_LPI_CAM1 + (x))
#define EXYNOS5430_LPI_MASK_CAM1_BUSMASTER			EXYNOS5430_PMU_LPI_CAM1_REG(0x0000)
#define EXYNOS5430_LPI_MASK_CAM1_BUSMASTER_FIMC_LITE_C		(1 << 0)
#define EXYNOS5430_LPI_MASK_CAM1_BUSMASTER_FIMC_FD		(1 << 1)
#define EXYNOS5430_LPI_MASK_CAM1_BUSMASTER_ALL			(0x3)
#define EXYNOS5430_LPI_MASK_CAM1_ASYNCBRIDGE			EXYNOS5430_PMU_LPI_CAM1_REG(0x0020)
#define EXYNOS5430_LPI_MASK_CAM1_ASYNCBRIDGE_ISP_CAM1_ISPEX	(1 << 0)
#define EXYNOS5430_LPI_MASK_CAM1_ASYNCBRIDGE_CAM1_CAM0_IS0X	(1 << 1)
#define EXYNOS5430_LPI_MASK_CAM1_ASYNCBRIDGE_CAM1_ISP_AXI0X	(1 << 2)
#define EXYNOS5430_LPI_MASK_CAM1_ASYNCBRIDGE_CAM1_ISP_AXI1X	(1 << 3)
#define EXYNOS5430_LPI_MASK_CAM1_ASYNCBRIDGE_CAM1_ISP_APB1P	(1 << 4)
#define EXYNOS5430_LPI_MASK_CAM1_ASYNCBRIDGE_CAM1_ISP_APB2P	(1 << 4)
#define EXYNOS5430_LPI_MASK_CAM1_ASYNCBRIDGE_ALL		(0x3F)
#define EXYNOS5430_LPI_MASK_CAM1_NOCBUS				EXYNOS5430_PMU_LPI_CAM1_REG(0x0040)
#define EXYNOS5430_LPI_MASK_CAM1_NOCBUS_D			(1 << 0)
#define EXYNOS5430_LPI_MASK_CAM1_NOCBUS_P			(1 << 1)
#define EXYNOS5430_LPI_MASK_CAM1_NOCBUS_ALL			(0x3)

#define EXYNOS5430_PMU_LPI_ISP_REG(x)				(EXYNOS5430_VA_PMU_LPI_ISP + (x))
#define EXYNOS5430_LPI_MASK_ISP_BUSMASTER			EXYNOS5430_PMU_LPI_ISP_REG(0x0000)
#define EXYNOS5430_LPI_MASK_ISP_BUSMASTER_FIMC_ISP		(1 << 0)
#define EXYNOS5430_LPI_MASK_ISP_BUSMASTER_FIMC_DRC		(1 << 1)
#define EXYNOS5430_LPI_MASK_ISP_BUSMASTER_FIMC_SCC		(1 << 2)
#define EXYNOS5430_LPI_MASK_ISP_BUSMASTER_FIMC_DIS		(1 << 3)
#define EXYNOS5430_LPI_MASK_ISP_BUSMASTER_FIMC_TDNR		(1 << 4)
#define EXYNOS5430_LPI_MASK_ISP_BUSMASTER_FIMC_SCP		(1 << 5)
#define EXYNOS5430_LPI_MASK_ISP_BUSMASTER_ALL			(0x3F)
#define EXYNOS5430_LPI_MASK_ISP_ASYNCBRIDGE			EXYNOS5430_PMU_LPI_ISP_REG(0x0020)
#define EXYNOS5430_LPI_MASK_ISP_ASYNCBRIDGE_CAM1_ISP_1P		(1 << 0)
#define EXYNOS5430_LPI_MASK_ISP_ASYNCBRIDGE_CAM1_ISP_2P		(1 << 1)
#define EXYNOS5430_LPI_MASK_ISP_ASYNCBRIDGE_ISP_CAM1		(1 << 2)
#define EXYNOS5430_LPI_MASK_ISP_ASYNCBRIDGE_CAM1_ISP_ISPSSCON2	(1 << 3)
#define EXYNOS5430_LPI_MASK_ISP_ASYNCBRIDGE_CAM1_ISP_APB1P	(1 << 4)
#define EXYNOS5430_LPI_MASK_ISP_ASYNCBRIDGE_ALL			(0x1F)
#define EXYNOS5430_LPI_MASK_ISP_NOCBUS				EXYNOS5430_PMU_LPI_ISP_REG(0x0040)
#define EXYNOS5430_LPI_MASK_ISP_NOCBUS_D			(1 << 0)
#define EXYNOS5430_LPI_MASK_ISP_NOCBUS_ALL			(0x1)

#define ENABLE_CPUSEQ						BIT(0)
#define USE_RETENTION						BIT(4)
#define USE_STANDBYWFIL2					BIT(16)
#define USE_DEACTIVATE_ACP					BIT(18)
#define USE_DEACTIVATE_ACE					BIT(19)
#define EXYNOS5430_SYS_WDTRESET_EGL				(1 << 23)
#define EXYNOS5430_SYS_WDTRESET_KFC				(1 << 24)
