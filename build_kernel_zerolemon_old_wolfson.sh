...
BK=build_kernel
sed -i 's/\-Standart\-/\-Extended\-/g' arch/arm/configs/trelte_oldWolfson_00_defconfig
...
GETVER=`grep 'SpaceLemon-Battery-Extended-v.*' arch/arm/configs/trelte_oldWolfson_00_defconfig | sed 's/.*-.//g' | sed 's/".*//g'`
###################################### DT.IMG GENERATION #####################################
echo -n "Build dt.img......................................."
...
zip -r N910C-H-SpaceLemon-v${GETVER}-zerolemon-old-wolfson-no-root.zip ./
