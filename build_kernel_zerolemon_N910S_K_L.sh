...
BK=build_kernel
sed -i 's/\-Standart\-/\-Extended\-/g' arch/arm/configs/exynos5433-trelteskt_defconfig
...
zip -r N910S-K-L-SpaceLemon-v${GETVER}-zerolemon.zip ./
...
zip -r N910S-K-L-SpaceLemon-v${GETVER}-zerolemon-no-root.zip ./
