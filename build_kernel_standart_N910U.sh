...
BK=build_kernel
sed -i 's/\-Extended\-/\-Standart\-/g' arch/arm/configs/trlte_00_defconfig
...
GETVER=`grep 'SpaceLemon-Battery-Standart-v.*' arch/arm/configs/trlte_00_defconfig | sed 's/.*-.//g' | sed 's/".*//g'`
###################################### DT.IMG GENERATION #####################################
echo -n "Build dt.img......................................."
...
zip -r N910U-SpaceLemon-v${GETVER}-Standart.zip ./

cd ../../

rm -f build_kernel/out-no-root/*.zip

cp -f build_kernel/AiK-N910U/image-new.img build_kernel/out-no-root/boot.img
...
zip -r N910U-SpaceLemon-v${GETVER}-standart-no-root.zip ./
