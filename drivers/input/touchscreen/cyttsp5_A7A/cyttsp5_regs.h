...
#define CONFIG_TOUCHSCREEN_CYPRESS_CYTTSP5_PLATFORM_FW_UPGRADE
...
#define CYTTSP5_RTD_TUNER_FILE_NAME "rtd_tuner"
#endif
...
#define HID_TTHE_DEBUG_REPORT_ID    0x6F
...
#endif
#ifdef RTD_TUNER_SUPPORT
	struct dentry *rtd_debugfs;
	u8 *rtd_buf;
	u32 rtd_buf_len;
	struct mutex rtd_lock;
	u8 rtd_exit;
#endif
...
#else
static inline int cyttsp5_samsung_factory_probe(struct device *dev) { return 0; }
...
#define CALIBRATION_DELAY 1000 // in ms, to avoid firmware's self calibration time.
#define CALIBRATION_RETRY_DELAY 500 // in ms
