...
static int bcm43457_bt_rfkill_set_power(void *data, bool blocked)
{
...
static const struct rfkill_ops bcm43457_bt_rfkill_ops = {
	.set_block = bcm43457_bt_rfkill_set_power,
};
...
static int bcm43457_bluetooth_remove(struct platform_device *pdev)
{
	rfkill_unregister(bt_rfkill);
	rfkill_destroy(bt_rfkill);
...
static struct platform_driver bcm43457_bluetooth_platform_driver = {
	.probe = bcm43457_bluetooth_probe,
	.remove = bcm43457_bluetooth_remove,
	.driver = {
		   .name = "bcm43457_bluetooth",
		   .owner = THIS_MODULE,
		   .of_match_table = exynos_bluetooth_match,
		   },
};

module_platform_driver(bcm43457_bluetooth_platform_driver);
#endif
MODULE_ALIAS("platform:bcm43457");
MODULE_DESCRIPTION("bcm43457_bluetooth");
MODULE_LICENSE("GPL");
