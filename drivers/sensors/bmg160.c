...
#else
#define bmg160_match_table	NULL
#endif
...
static struct i2c_driver bmg160_driver = {
	.driver = {
		...
		.pm = &bmg160_pm_ops,
#ifdef CONFIG_OF
		.of_match_table = of_match_ptr(bmg160_match_table),
#endif
	},
	.probe		= bmg160_probe,
