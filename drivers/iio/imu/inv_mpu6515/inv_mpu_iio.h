...
/**
 *  struct inv_lcd_pos structure to store LCD position.
 *  @en:    up/down enable.
 *  @time: time threshold in ms.
 *  @up_x: x threshold for up position in mg;
 *  @up_y: y threshold for up position in mg;
 *  @up_z: z threshold for up position in mg;
 *  @down_x: x threshold for down position in mg;
 *  @down_y: y threshold for down position in mg;
 *  @down_z: z threshold for down position in mg;
 *  @data: data from DMP interrupt.
 */
struct inv_lcd_pos {
	bool en;
	u32 time;
...
enum MPU_IIO_ATTR_ADDR {
	...
	ATTR_DMP_TAP_TIME,
	ATTR_DMP_LCD_POS_ENABLE,
	ATTR_DMP_LCD_POS_TIME_THRESH,
	ATTR_DMP_LCD_POS_UP_X_THRESH,
	ATTR_DMP_LCD_POS_UP_Y_THRESH,
	ATTR_DMP_LCD_POS_UP_Z_THRESH,
	ATTR_DMP_LCD_POS_DOWN_X_THRESH,
