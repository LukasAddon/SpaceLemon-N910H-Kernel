					...
					int old_idx)
{
	...
	sec_debug_aux_log(SEC_DEBUG_AUXLOG_CPU_BUS_CLOCK_CHANGE,
		"[DISP] %7d <= %7d",
		devfreq_disp_opp_list[target_idx].freq, devfreq_disp_opp_list[old_idx].freq);
					...
					int old_idx)
{
	...
	sec_debug_aux_log(SEC_DEBUG_AUXLOG_CPU_BUS_CLOCK_CHANGE,
		"[ISP] %7d <= %7d",
		devfreq_isp_opp_list[target_idx].freq, devfreq_isp_opp_list[old_idx].freq);
					...
					int old_idx)
{
	...
	sec_debug_aux_log(SEC_DEBUG_AUXLOG_CPU_BUS_CLOCK_CHANGE,
		"[MIF] %7d <= %7d",
		devfreq_mif_opp_list[target_idx].freq, devfreq_mif_opp_list[old_idx].freq);
