...
#define INTEG_FROM_COMBINATION // We will remove this code
			...
			struct sec_fuelgauge_info *fuelgauge)
{
	...
	if (np == NULL) {
		...
		pr_info("%s : max - %d / max_margin - %d / min - %d / cal_type - %d\n", __func__, pdata->capacity_max, pdata->capacity_max_margin, pdata->capacity_min, pdata->capacity_calculation_type);
