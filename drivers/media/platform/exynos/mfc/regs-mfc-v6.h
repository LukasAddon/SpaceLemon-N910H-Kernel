...
/* Decoder SFRs for MFC v7.x or later */
#define S5P_FIMV_D_MIN_NUM_DIS			0xF104
#define S5P_FIMV_D_MIN_FIRST_DIS_SIZE		0xF108
#define S5P_FIMV_D_MIN_SECOND_DIS_SIZE		0xF10C
#define S5P_FIMV_D_MIN_THIRD_DIS_SIZE		0xF110
#define S5P_FIMV_E_GOP_CONFIG2			0xFA5C
#define S5P_FIMV_D_DISPLAY_FIRST_ADDR		0xF600
#define S5P_FIMV_D_DISPLAY_SECOND_ADDR		0xF604
#define S5P_FIMV_D_DISPLAY_THIRD_ADDR		0xF608
#define S5P_FIMV_D_DECODED_FIRST_ADDR		0xF60C
#define S5P_FIMV_D_DECODED_SECOND_ADDR		0xF610
#define S5P_FIMV_D_DECODED_THIRD_ADDR		0xF614

/* Encoder SFRs for MFC v7.x or later */
#define S5P_FIMV_E_AIR_THRESHOLD		0xF7A8
...
#define S5P_FIMV_E_VP8_NUM_T_LAYER		0xFDC4
#define S5P_FIMV_E_VP8_HIERARCHICAL_QP_LAYER0	0xFDC8
