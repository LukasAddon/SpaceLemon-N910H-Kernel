/* linux/drivers/media/platform/exynos/jpeg_hx/jpeg_hx_regs.h
 *
...
void jpeg_hx_set_luma_stride(void __iomem *base, unsigned int w_stride, enum jpeg_frame_format fmt);
void jpeg_hx_set_cbcr_stride(void __iomem *base, unsigned int w_stride, enum jpeg_frame_format fmt);
