...
#if defined(CONFIG_CAMERA_GTS2)
	/* 1936x1090@30fps */
	FIMC_IS_SENSOR_CFG(1936, 1090, 30, 16, 0),
	/* 1936x1090@24fps */
	FIMC_IS_SENSOR_CFG(1936, 1090, 24, 16, 1),
	/* 1296x730@30fps */
...
static int sensor_6b2_power_setpin(struct device *dev)
{
	...
	if (cam_1p2v_use) {
		...
		SET_PIN(pdata, SENSOR_SCENARIO_NORMAL, GPIO_SCENARIO_ON, 2, gpio_none, 0, "VT_CAM_1.8V", 1000, PIN_REGULATOR_ON);
