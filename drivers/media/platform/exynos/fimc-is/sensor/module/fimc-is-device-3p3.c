...
static int sensor_3p3_power_setpin(struct device *dev)
{
	return 0;
}
#else
	...
	const struct i2c_device_id *id)
{
	...
	device = &core->sensor[SENSOR_S5K3P3_INSTANCE];
	...
	module->id = SENSOR_NAME_S5K3P3;
	module->subdev = subdev_module;
	module->device = SENSOR_S5K3P3_INSTANCE;
	module->ops = NULL;
...
#ifdef CONFIG_OF
	module->power_setpin = sensor_3p3_power_setpin;
#endif
	...
	ext->actuator_con.product_name = ACTUATOR_NAME_DW9807;
