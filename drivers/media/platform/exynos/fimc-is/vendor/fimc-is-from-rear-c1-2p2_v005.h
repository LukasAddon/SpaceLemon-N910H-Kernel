...
#define FROM_HEADER_CONCORD_CAL_END 0xF23F
...
#define FROM_HEADER_PDAF_CAL_START 0x5000
#define FROM_HEADER_PDAF_CAL_END_V005 0x540F
#define FROM_HEADER_PDAF_CAL_END_V000 0x521F
...
#define FROM_CONCORD_XTALK_60_END_ADDR 0xF1CF
