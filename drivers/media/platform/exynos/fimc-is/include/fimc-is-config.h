...
#if defined(CONFIG_CAMERA_TBE) || defined(CONFIG_CAMERA_TRE) || defined(CONFIG_CAMERA_TR)
#include "../vendor/fimc-is-vendor-config_tbe.h"
#elif defined(CONFIG_CAMERA_ALPHA)
#include "../vendor/fimc-is-vendor-config_alpha.h"
#elif defined(CONFIG_CAMERA_GTS2)
#include "../vendor/fimc-is-vendor-config_gts2.h"
#elif defined(CONFIG_CAMERA_CHAGALLHLTE)
#include "../vendor/fimc-is-vendor-config_chagallhlte.h"
#elif defined(CONFIG_CAMERA_A7)
#include "../vendor/fimc-is-vendor-config_a7.h"
#elif defined(CONFIG_CAMERA_A8)
#include "../vendor/fimc-is-vendor-config_a8.h"
#else /* CONFIG_CAMERA_K3G */
#include "../vendor/fimc-is-vendor-config_k3g.h"
#endif
