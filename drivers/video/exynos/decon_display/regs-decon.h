/* drivers/video/decon_display/regs-decon.h
 *
 * Copyright 2013 Samsung Electronics
 *     Haowei Li <haowei.li@samsung.com>
 *
 * New-style Display and Enhancement Controller(DECON) register definitions
 *
...
#define DECON_CMU_ALL_CLKGATE_ENABLE		(0x7)
