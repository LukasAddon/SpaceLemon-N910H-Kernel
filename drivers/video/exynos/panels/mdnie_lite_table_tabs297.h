#ifndef __MDNIE_TABLE_TABS297_H__
#define __MDNIE_TABLE_TABS297_H__
...
static unsigned char coordinate_data_1[] = {
	...
	0xfc, 0xfa, 0xff, /* Tune_3 */
	0xff, 0xfe, 0xfc, /* Tune_4 */
	0xff, 0xff, 0xff, /* Tune_5 */
	0xfb, 0xfd, 0xff, /* Tune_6 */
	0xfd, 0xff, 0xfb, /* Tune_7 */
	0xfd, 0xff, 0xfd, /* Tune_8 */
	0xfc, 0xff, 0xff, /* Tune_9 */
};
...
static unsigned char coordinate_data_2[] = {
	...
	0xff, 0xfb, 0xf2, /* Tune_5 */
	0xff, 0xfc, 0xf5, /* Tune_6 */
	0xff, 0xfd, 0xf0, /* Tune_7 */
	0xff, 0xfd, 0xf2, /* Tune_8 */
	0xff, 0xfe, 0xf5, /* Tune_9 */
};
...
static unsigned char MDNIE_ADDRESS_1[] = {
	0xB0,
	0xA8
};

static unsigned char MDNIE_ADDRESS_2[] = {
	0xB0,
	0x42
};
...
{							\
	...
	.update_flag	= {0, 1, 0, 2},			\
	.seq		= {				\
		{	.cmd = MDNIE_ADDRESS_1,	.len = ARRAY_SIZE(MDNIE_ADDRESS_1),	.sleep = 0,},	\
		{	.cmd = id##_1,		.len = ARRAY_SIZE(id##_1),		.sleep = 0,},	\
		{	.cmd = MDNIE_ADDRESS_2,	.len = ARRAY_SIZE(MDNIE_ADDRESS_2),	.sleep = 0,},	\
