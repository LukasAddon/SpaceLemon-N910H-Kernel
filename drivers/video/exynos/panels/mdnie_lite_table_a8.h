...
static unsigned char coordinate_data_2[] = {
	...
	0xff, 0xf8, 0xf2, /* Tune_3 */
	0xff, 0xf8, 0xeb, /* Tune_4 */
	0xff, 0xf9, 0xee, /* Tune_5 */
	0xff, 0xfa, 0xf2, /* Tune_6 */
	0xff, 0xfa, 0xeb, /* Tune_7 */
	0xff, 0xfc, 0xee, /* Tune_8 */
	0xff, 0xfc, 0xf1, /* Tune_9 */
};
...
static unsigned char START_DMB_2[] = {
	0xF2,
	0x01, 0x00, 0x02, 0x6B
};
...
static unsigned char END_DMB_1[] = {
	0xCE,
	0x29, 0xD0, 0x50, 0x35, 0x4B,
	0x38, 0x06, 0x03, 0x00, 0xFF,
	0x0A, 0x3F, 0x3F, 0x3F, 0x3F
};

static unsigned char END_DMB_2[] = {
	0xF2,
	0x01, 0x00, 0x02, 0x5A
};
...
{							\
	...
	.seq		= {				\
		...
		{	.cmd = END_DMB_2,		.len = ARRAY_SIZE(END_DMB_2),		.sleep = 0,},	\
...
{							\
	...
	.seq		= {				\
		...
		{	.cmd = START_DMB_2,		.len = ARRAY_SIZE(START_DMB_2),		.sleep = 0,},	\
		{	.cmd = LEVEL_LOCK,	.len = ARRAY_SIZE(LEVEL_LOCK),		.sleep = 0,},	\
	}	\
}
