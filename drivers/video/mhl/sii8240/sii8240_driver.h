 ...
 *
 */
#ifndef __SII8240_DRIVER_H__
#define __SII8240_DRIVER_H__
...
#define MHL_VER_MAJOR	(CONFIG_MHL_VERSION >> 4)
#define MHL_VER_MINOR	(CONFIG_MHL_VERSION & 0x0F)
...
#define T_WAIT_TIMEOUT_RGND_INT		6000
#define T_WAIT_TIMEOUT_DISC_INT		4000
 ...
 */
enum mhl_power_state {
	POWER_STATE_D3,/* Lowest Power State */
	POWER_STATE_D2,
	POWER_STATE_D0,/* Highest power state,Full Operation */
	POWER_STATE_NONE,
};
...
extern int exynos_get_edid(u8 *edid, int size, u8 mhl_ver);
