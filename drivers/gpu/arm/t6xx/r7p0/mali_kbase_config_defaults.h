 ...
 * context)
 */
#define DEFAULT_JS_SOFT_STOP_TICKS       (8) /* 800ms */

/*
 * Default minimum number of scheduling ticks before CL jobs are soft-stopped.
 */
#define DEFAULT_JS_SOFT_STOP_TICKS_CL    (8) /* 800ms */

/*
 * Default minimum number of scheduling ticks before jobs are hard-stopped
 */
#define DEFAULT_JS_HARD_STOP_TICKS_SS    (57) /* 5.7s */
#define DEFAULT_JS_HARD_STOP_TICKS_SS_8408  (300) /* 30s */

/*
 * Default minimum number of scheduling ticks before CL jobs are hard-stopped.
 */
#define DEFAULT_JS_HARD_STOP_TICKS_CL    (57) /* 5.7s */
 ...
 * "stuck" job
 */
#define DEFAULT_JS_RESET_TICKS_SS           (62) /* 6.2s */
 ...
 * "stuck" CL job.
 */
#define DEFAULT_JS_RESET_TICKS_CL        (62) /* 6.2s */
