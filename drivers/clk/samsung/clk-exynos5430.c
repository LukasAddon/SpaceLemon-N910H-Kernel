...
enum exynos5430_clks {
	...
	sclk_usbdrd30_fsys = 50, sclk_ufsunipro_fsys, sclk_mmc0_fsys,
	sclk_mmc1_fsys, sclk_mmc2_fsys,
	...
	/* gate clocks */
	aclk_cpif_200 = 320, aclk_disp_333, aclk_bus1_400, aclk_bus2_400,
	...
	aclk_axius_usbhs, aclk_axius_pdma, aclk_bts_usbdrd30, aclk_bts_ufs,
	aclk_smmu_pdma = 590, aclk_smmu_mmc0, aclk_smmu_mmc1, aclk_smmu_mmc2, aclk_ppmu_fsys,
	pclk_gpio_fsys, pclk_pmu_fsys, pclk_sysreg_fsys, pclk_bts_usbdrd30,
	...
	gate_bts_ufs, gate_bts_usbdrd30,
...
static __initdata void *exynos5430_clk_regs[] = {
	...
	EXYNOS5430_ENABLE_IP_EGL0,
	EXYNOS5430_CLKOUT_CMU_EGL,
	EXYNOS5430_ENABLE_IP_FSYS0,
	EXYNOS5430_ENABLE_IP_FSYS1,
	EXYNOS5430_ENABLE_IP_KFC0,
	EXYNOS5430_CLKOUT_CMU_KFC,
	EXYNOS5430_ENABLE_IP_PERIS0,
	EXYNOS5430_CLKOUT_CMU_MIF,
	EXYNOS5430_ENABLE_SCLK_CPIF,
	EXYNOS5430_ENABLE_IP_CPIF1,
	EXYNOS5430_SRC_ENABLE_TOP_FSYS0,
	EXYNOS5430_CLKOUT_CMU_TOP,
	EXYNOS5430_SRC_STAT_FSYS2,
	EXYNOS5430_SRC_STAT_TOP_FSYS0,
...
#ifdef CONFIG_EXYNOS5430_HD
	/* PLL_CON */
	EXYNOS5430_MEM0_PLL_CON0,
#endif
	EXYNOS5430_SRC_SEL_CPIF0,
	EXYNOS5430_MPHY_PLL_CON0,
	EXYNOS5430_MPHY_PLL_CON1,
};
...
PNAME(mout_bus_pll_egl_user_p)	= { "fin_pll", "sclk_bus_pll" };
PNAME(mout_egl_p)		= { "mout_egl_pll", "mout_bus_pll_egl_user" };
PNAME(mout_kfc_pll_p)		= { "fin_pll", "fout_kfc_pll" };
PNAME(mout_bus_pll_kfc_user_p)	= { "fin_pll", "sclk_bus_pll" };
...
PNAME(mout_aclk_mfc0_333_a_p)	= { "mout_mfc_pll_user", "mout_isp_pll" };
PNAME(mout_aclk_mfc0_333_b_p)	= { "mout_aclk_mfc0_333_a", "mout_bus_pll_user" };
PNAME(mout_aclk_mfc0_333_c_p)	= { "mout_aclk_mfc0_333_b", "mout_mphy_pll_user" };
PNAME(mout_aclk_mfc1_333_a_p)	= { "mout_mfc_pll_user", "mout_isp_pll" };
PNAME(mout_aclk_mfc1_333_b_p)	= { "mout_aclk_mfc1_333_a", "mout_bus_pll_user" };
...
PNAME(mout_sclk_slimbus_p)	= { "oscclk", "mout_aud_pll_user_top" };
...
PNAME(mout_sclk_decon_eclk_c_p) = { "mout_sclk_decon_eclk_b", "sclk_mphy_pll" };
...
PNAME(mout_sclk_decon_vclk_c_p) = { "mout_sclk_decon_vclk_b", "sclk_mphy_pll" };
...
PNAME(mout_sclk_decon_tv_eclk_c_p) = { "mout_sclk_decon_tv_eclk_b", "sclk_mphy_pll" };
...
struct samsung_mux_clock exynos5430_mux_clks[] __initdata = {
	...
	CMX_STAT(mout_mfc_pll_user, EXYNOS5430_SRC_SEL_TOP1, 4, 1, EXYNOS5430_SRC_STAT_TOP1, 4, 3),
	CMX_STAT(mout_mphy_pll_user, EXYNOS5430_SRC_SEL_TOP1, 8, 1, EXYNOS5430_SRC_STAT_TOP1, 8, 3),
	CMX_STAT(mout_isp_pll, EXYNOS5430_SRC_SEL_TOP0, 0, 1, EXYNOS5430_SRC_STAT_TOP0, 0, 3),
	...
	CMX_STAT(mout_aclk_mscl_400_a, EXYNOS5430_SRC_SEL_TOP3, 12, 1, EXYNOS5430_SRC_STAT_TOP3, 12, 3),
	CMX_STAT(mout_aclk_mscl_400_b, EXYNOS5430_SRC_SEL_TOP3, 16, 1, EXYNOS5430_SRC_STAT_TOP3, 16, 3),
	CMX_STAT(mout_aclk_g2d_400_a, EXYNOS5430_SRC_SEL_TOP3, 0, 1, EXYNOS5430_SRC_STAT_TOP3, 0, 3),
	CMX_STAT(mout_aclk_g2d_400_b, EXYNOS5430_SRC_SEL_TOP3, 4, 1, EXYNOS5430_SRC_STAT_TOP3, 4, 3),
	CMX_STAT(mout_aclk_mfc0_333_a, EXYNOS5430_SRC_SEL_TOP4, 0, 1, EXYNOS5430_SRC_STAT_TOP4, 0, 3),
	CMX_STAT(mout_aclk_mfc0_333_b, EXYNOS5430_SRC_SEL_TOP4, 4, 1, EXYNOS5430_SRC_STAT_TOP4, 4, 3),
	CMX_STAT(mout_aclk_mfc0_333_c, EXYNOS5430_SRC_SEL_TOP4, 8, 1, EXYNOS5430_SRC_STAT_TOP4, 8, 3),
	CMX_STAT(mout_aclk_mfc1_333_a, EXYNOS5430_SRC_SEL_TOP4, 16, 1, EXYNOS5430_SRC_STAT_TOP4, 16, 3),
	CMX_STAT(mout_aclk_mfc1_333_b, EXYNOS5430_SRC_SEL_TOP4, 20, 1, EXYNOS5430_SRC_STAT_TOP4, 20, 3),
	CMX_STAT(mout_aclk_mfc1_333_c, EXYNOS5430_SRC_SEL_TOP4, 24, 1, EXYNOS5430_SRC_STAT_TOP4, 24, 3),
	CMX_STAT(mout_aclk_isp_400, EXYNOS5430_SRC_SEL_TOP2, 0, 1, EXYNOS5430_SRC_STAT_TOP2, 0, 3),
	CMX_STAT(mout_aclk_isp_dis_400, EXYNOS5430_SRC_SEL_TOP2, 4, 1, EXYNOS5430_SRC_STAT_TOP2, 4, 3),
	CMX_STAT(mout_aclk_cam1_552_a, EXYNOS5430_SRC_SEL_TOP2, 8, 1, EXYNOS5430_SRC_STAT_TOP2, 8, 3),
	CMX_STAT(mout_aclk_cam1_552_b, EXYNOS5430_SRC_SEL_TOP2, 12, 1, EXYNOS5430_SRC_STAT_TOP2, 12, 3),
	...
	CMUX(mout_sclk_slimbus, EXYNOS5430_SRC_SEL_TOP_PERIC1, 16, 1),
	...
	CMX_STAT(mout_sclk_slimbus, EXYNOS5430_SRC_SEL_TOP_PERIC1, 16, 1, EXYNOS5430_SRC_STAT_TOP_PERIC1, 16, 3),
	...
	CMX_STAT(mout_sclk_jpeg_a, EXYNOS5430_SRC_SEL_TOP_MSCL, 0, 1, EXYNOS5430_SRC_STAT_TOP_MSCL, 0, 3),
	CMX_STAT(mout_sclk_jpeg_b, EXYNOS5430_SRC_SEL_TOP_MSCL, 4, 1, EXYNOS5430_SRC_STAT_TOP_MSCL, 4, 3),
	CMX_STAT(mout_sclk_jpeg_c, EXYNOS5430_SRC_SEL_TOP_MSCL, 8, 1, EXYNOS5430_SRC_STAT_TOP_MSCL, 8, 3),
	...
	/* MIF */
	CMX_STAT(mout_mem0_pll, EXYNOS5430_SRC_SEL_MIF0, 0, 1, EXYNOS5430_SRC_STAT_MIF0, 0, 3),
	CMX_STAT(mout_mem1_pll, EXYNOS5430_SRC_SEL_MIF0, 4, 1, EXYNOS5430_SRC_STAT_MIF0, 4, 3),
	CMX_STAT(mout_mfc_pll, EXYNOS5430_SRC_SEL_MIF0, 12, 1, EXYNOS5430_SRC_STAT_MIF0, 12, 3),
	CMX_STAT(mout_bus_pll, EXYNOS5430_SRC_SEL_MIF0, 8, 1, EXYNOS5430_SRC_STAT_MIF0, 8, 3),
	CMX_STAT(mout_mem0_pll_div2, EXYNOS5430_SRC_SEL_MIF0, 16, 1, EXYNOS5430_SRC_STAT_MIF0, 16, 3),
	CMX_STAT(mout_mem1_pll_div2, EXYNOS5430_SRC_SEL_MIF0, 20, 1, EXYNOS5430_SRC_STAT_MIF0, 20, 3),
	CMX_STAT(mout_mfc_pll_div2, EXYNOS5430_SRC_SEL_MIF0, 28, 1, EXYNOS5430_SRC_STAT_MIF0, 28, 3),
	CMX_STAT(mout_bus_pll_div2, EXYNOS5430_SRC_SEL_MIF0, 24, 1, EXYNOS5430_SRC_STAT_MIF0, 24, 3),
	...
	CMX_STAT(mout_aclk_mif_400, EXYNOS5430_SRC_SEL_MIF2, 0, 1, EXYNOS5430_SRC_STAT_MIF2, 0, 3),
	CMX_STAT(mout_aclk_mifnm_200, EXYNOS5430_SRC_SEL_MIF2, 8, 1, EXYNOS5430_SRC_STAT_MIF2, 8, 3),
	...
	CMX_STAT(mout_aclk_mfc0_333_user, EXYNOS5430_SRC_SEL_MFC0, 0, 1, EXYNOS5430_SRC_STAT_MFC0, 0, 3),
	CMX_STAT(mout_aclk_mfc1_333_user, EXYNOS5430_SRC_SEL_MFC1, 0, 1, EXYNOS5430_SRC_STAT_MFC1, 0, 3),
	...
	CMX_STAT(mout_aclk_cam0_552_user, EXYNOS5430_SRC_SEL_CAM00, 0, 1, EXYNOS5430_SRC_STAT_CAM00, 0, 3),
	CMX_STAT(mout_aclk_cam0_400_user, EXYNOS5430_SRC_SEL_CAM00, 4, 1, EXYNOS5430_SRC_STAT_CAM00, 4, 3),
	CMX_STAT(mout_aclk_cam0_333_user, EXYNOS5430_SRC_SEL_CAM00, 8, 1, EXYNOS5430_SRC_STAT_CAM00, 8, 3),
	CMX_STAT(mout_aclk_lite_a_a, EXYNOS5430_SRC_SEL_CAM02, 4, 1, EXYNOS5430_SRC_STAT_CAM02, 4, 3),
	CMX_STAT(mout_aclk_lite_a_b, EXYNOS5430_SRC_SEL_CAM02, 8, 1, EXYNOS5430_SRC_STAT_CAM02, 8, 3),
	CMX_STAT(mout_aclk_lite_b_a, EXYNOS5430_SRC_SEL_CAM02, 12, 1, EXYNOS5430_SRC_STAT_CAM02, 12, 3),
	...
	CMX_STAT(mout_sclk_pixelasync_lite_c_b, EXYNOS5430_SRC_SEL_CAM04, 12, 1, EXYNOS5430_SRC_STAT_CAM04, 12, 3),
	CMX_STAT(mout_aclk_3aa0_a, EXYNOS5430_SRC_SEL_CAM03, 0, 1, EXYNOS5430_SRC_STAT_CAM03, 0, 3),
	CMX_STAT(mout_aclk_3aa0_b, EXYNOS5430_SRC_SEL_CAM03, 4, 1, EXYNOS5430_SRC_STAT_CAM03, 4, 3),
	CMX_STAT(mout_aclk_3aa1_a, EXYNOS5430_SRC_SEL_CAM03, 8, 1, EXYNOS5430_SRC_STAT_CAM03, 8, 3),
	CMX_STAT(mout_aclk_3aa1_b, EXYNOS5430_SRC_SEL_CAM03, 12, 1, EXYNOS5430_SRC_STAT_CAM03, 12, 3),
	CMX_STAT(mout_aclk_csis0_a, EXYNOS5430_SRC_SEL_CAM03, 16, 1, EXYNOS5430_SRC_STAT_CAM03, 16, 3),
	CMX_STAT(mout_aclk_csis0_b, EXYNOS5430_SRC_SEL_CAM03, 20, 1, EXYNOS5430_SRC_STAT_CAM03, 20, 3),
	CMX_STAT(mout_aclk_csis1_a, EXYNOS5430_SRC_SEL_CAM03, 24, 1, EXYNOS5430_SRC_STAT_CAM03, 24, 3),
	CMX_STAT(mout_aclk_csis1_b, EXYNOS5430_SRC_SEL_CAM03, 28, 1, EXYNOS5430_SRC_STAT_CAM03, 28, 3),
	...
	CMX_STAT(mout_sclk_lite_freecnt_b, EXYNOS5430_SRC_SEL_CAM04, 20, 1, EXYNOS5430_SRC_STAT_CAM04, 20, 3),
	CMX_STAT(mout_sclk_lite_freecnt_c, EXYNOS5430_SRC_SEL_CAM04, 24, 1, EXYNOS5430_SRC_STAT_CAM04, 24, 3),

	CMX_STAT(mout_aclk_cam1_552_user, EXYNOS5430_SRC_SEL_CAM10, 0, 1, EXYNOS5430_SRC_STAT_CAM10, 0, 3),
	CMX_STAT(mout_aclk_cam1_400_user, EXYNOS5430_SRC_SEL_CAM10, 4, 1, EXYNOS5430_SRC_STAT_CAM10, 4, 3),
	CMX_STAT(mout_aclk_cam1_333_user, EXYNOS5430_SRC_SEL_CAM10, 8, 1, EXYNOS5430_SRC_STAT_CAM10, 8, 3),
	CMX_STAT(mout_aclk_lite_c_a, EXYNOS5430_SRC_SEL_CAM12, 0, 1, EXYNOS5430_SRC_STAT_CAM12, 0, 3),
	CMX_STAT(mout_aclk_lite_c_b, EXYNOS5430_SRC_SEL_CAM12, 4, 1, EXYNOS5430_SRC_STAT_CAM12, 4, 3),
	CMX_STAT(mout_aclk_fd_a, EXYNOS5430_SRC_SEL_CAM12, 8, 1, EXYNOS5430_SRC_STAT_CAM12, 8, 3),
	CMX_STAT(mout_aclk_fd_b, EXYNOS5430_SRC_SEL_CAM12, 12, 1, EXYNOS5430_SRC_STAT_CAM12, 12, 3),
	CMX_STAT(mout_aclk_csis2_a, EXYNOS5430_SRC_SEL_CAM12, 16, 1, EXYNOS5430_SRC_STAT_CAM12, 16, 3),
	CMX_STAT(mout_aclk_csis2_b, EXYNOS5430_SRC_SEL_CAM12, 20, 1, EXYNOS5430_SRC_STAT_CAM12, 20, 3),
...
struct samsung_div_clock exynos5430_div_clks[] __initdata = {
	...
	CDIV(dout_aclk_bus1_400, "mout_bus_pll_user", EXYNOS5430_DIV_TOP4, 0, 3),
	...
	CDIV(dout_aclk_mfc0_333, "mout_aclk_mfc0_333_c", EXYNOS5430_DIV_TOP1, 12, 3),
	CDIV(dout_aclk_mfc1_333, "mout_aclk_mfc1_333_c", EXYNOS5430_DIV_TOP1, 16, 3),
	...
	CDIV(dout_sclk_slimbus, "mout_sclk_slimbus", EXYNOS5430_DIV_TOP_PERIC3, 24, 5),
	...
	/* MIF */
	CDIV(dout_mif_pre, "mout_bus_pll_div2", EXYNOS5430_DIV_MIF5, 0, 3),
	CDIV(dout_clk2x_phy, "mout_clk2x_phy_c", EXYNOS5430_DIV_MIF1, 4, 4),
	CDIV(dout_aclk_mif_400, "mout_aclk_mif_400", EXYNOS5430_DIV_MIF2, 0, 3),
	...
	CDIV(dout_aclk_mifnm_200, "mout_aclk_mifnm_200", EXYNOS5430_DIV_MIF2, 8, 3),
	CDIV(dout_aclk_mifnd_133, "dout_mif_pre", EXYNOS5430_DIV_MIF2, 16, 4),
	CDIV(dout_aclk_mif_133, "dout_mif_pre", EXYNOS5430_DIV_MIF2, 12, 4),
	CDIV(dout_aclk_cpif_200, "mout_aclk_mifnm_200", EXYNOS5430_DIV_MIF3, 0, 3),
	CDIV(dout_aclk_bus2_400, "dout_mif_pre", EXYNOS5430_DIV_MIF3, 16, 4),
	...
	CDIV(dout_sclk_dsd, "mout_sclk_dsd_c", EXYNOS5430_DIV_MIF4, 12, 4),
	...
	CDIV(dout_aclk_cam0_bus_400, "mout_aclk_cam0_400", EXYNOS5430_DIV_CAM00, 0, 3),
	...
	CDIV(dout_aclk_fd, "mout_aclk_fd_b", EXYNOS5430_DIV_CAM11, 8, 3),
	CDIV(dout_aclk_csis2, "mout_aclk_csis2_b", EXYNOS5430_DIV_CAM11, 16, 3),
...
struct samsung_gate_clock exynos5430_gate_clks[] __initdata = {
	...
	CGTE(aclk_cam0_400, "aclk_cam0_400", "dout_aclk_cam0_400", EXYNOS5430_ENABLE_ACLK_TOP, 9, CLK_SET_RATE_PARENT | CLK_IGNORE_UNUSED, 0),
	...
	CGTE(sclk_ufsunipro_fsys, "sclk_ufsunipro_fsys", "dout_sclk_ufsunipro", EXYNOS5430_ENABLE_SCLK_TOP_FSYS, 3, CLK_IGNORE_UNUSED, 0),
	...
	CGTE(phyclk_hdmiphy_tmds_clko, "phyclk_hdmiphy_tmds_clko", "mout_phyclk_hdmiphy_tmds_clko_user", EXYNOS5430_ENABLE_SCLK_DISP, 11, CLK_IGNORE_UNUSED, 0),
	...
	CGTE(sclk_slimbus, "sclk_slimbus", "sclk_slimbus_peric", EXYNOS5430_ENABLE_SCLK_PERIC, 9, CLK_IGNORE_UNUSED, 0),
	...
	CGTE(sclk_lite_freecnt, "sclk_lite_freecnt", "mout_sclk_lite_freecnt_b", EXYNOS5430_ENABLE_SCLK_CAM0, 6, 0, 0),
	CGTE(sclk_pixel_init, "sclk_pixel_init", "dout_sclk_pixelasync_lite_c_init", EXYNOS5430_ENABLE_SCLK_CAM0, 1, 0, 0),
	CGTE(sclk_pixel, "sclk_pixel", "dout_sclk_pixelasync_lite_c", EXYNOS5430_ENABLE_SCLK_CAM0, 2, 0, 0),
#endif
	...
	/*CGTE(aclk_asyncaximm_tvx, "aclk_asyncaximm_tvx", "mout_aclk_disp_333_user", EXYNOS5430_ENABLE_ACLK_DISP1, 5, CLK_IGNORE_UNUSED, 0),*/
	...
	CGTE(aclk_bts_mfc0_0, "aclk_bts_mfc0_0", "mout_aclk_mfc0_333_user", EXYNOS5430_ENABLE_ACLK_MFC0, 5, CLK_IGNORE_UNUSED, 0),
	CGTE(aclk_bts_mfc0_1, "aclk_bts_mfc0_1", "mout_aclk_mfc0_333_user", EXYNOS5430_ENABLE_ACLK_MFC0, 6, CLK_IGNORE_UNUSED, 0),
	...
	CGTE(pclk_bts_mfc0_0, "pclk_bts_mfc0_0", "dout_pclk_mfc0", EXYNOS5430_ENABLE_PCLK_MFC0, 3, CLK_IGNORE_UNUSED, 0),
	CGTE(pclk_bts_mfc0_1, "pclk_bts_mfc0_1", "dout_pclk_mfc0", EXYNOS5430_ENABLE_PCLK_MFC0, 4, CLK_IGNORE_UNUSED, 0),
	...
	CGTE(aclk_bts_mfc1_0, "aclk_bts_mfc1_0", "mout_aclk_mfc1_333_user", EXYNOS5430_ENABLE_ACLK_MFC1, 5, CLK_IGNORE_UNUSED, 0),
	CGTE(aclk_bts_mfc1_1, "aclk_bts_mfc1_1", "mout_aclk_mfc1_333_user", EXYNOS5430_ENABLE_ACLK_MFC1, 6, CLK_IGNORE_UNUSED, 0),
	...
	CGTE(pclk_bts_mfc1_0, "pclk_bts_mfc1_0", "dout_pclk_mfc1", EXYNOS5430_ENABLE_PCLK_MFC1, 3, CLK_IGNORE_UNUSED, 0),
	CGTE(pclk_bts_mfc1_1, "pclk_bts_mfc1_1", "dout_pclk_mfc1", EXYNOS5430_ENABLE_PCLK_MFC1, 4, CLK_IGNORE_UNUSED, 0),
	...
	CGTE(aclk_bts_sss_cci, "aclk_bts_sss_cci", "aclk_imem_266", EXYNOS5430_ENABLE_ACLK_IMEM, 13, CLK_IGNORE_UNUSED, 0),
	CGTE(aclk_bts_sss_dram, "aclk_bts_sss_dram", "aclk_imem_266", EXYNOS5430_ENABLE_ACLK_IMEM, 14, CLK_IGNORE_UNUSED, 0),
	CGTE(aclk_bts_slimsss, "aclk_bts_slimsss", "aclk_imem_266", EXYNOS5430_ENABLE_ACLK_IMEM, 15, CLK_IGNORE_UNUSED, 0),
	...
	/* IP Gate */
	/* KFC */
	CGTE(gate_freq_det_kfc_pll, "gate_freq_det_kfc_pll", NULL, EXYNOS5430_ENABLE_IP_KFC0, 4, 0, 0),
	CGTE(gate_hpm_kfc, "gate_hpm_kfc", NULL, EXYNOS5430_ENABLE_IP_KFC0, 3, 0, 0),

	/* EGL */
	CGTE(gate_freq_det_egl_pll, "gate_freq_det_egl_pll", NULL, EXYNOS5430_ENABLE_IP_EGL0, 6, 0, 0),
	CGTE(gate_hpm_egl_enable, "gate_hpm_egl_enable", NULL, EXYNOS5430_ENABLE_IP_EGL0, 5, 0, 0),


	/* TOP */
	CGTE(gate_top_cam1, "gate_top_cam1", NULL, EXYNOS5430_ENABLE_IP_TOP, 6, CLK_IGNORE_UNUSED, 0),
	...
	CGTE(gate_bts_mfc1_1, "gate_bts_mfc1_1", NULL, EXYNOS5430_ENABLE_IP_MFC11, 5, CLK_IGNORE_UNUSED, 0),
	CGTE(gate_bts_mfc1_0, "gate_bts_mfc1_0", NULL, EXYNOS5430_ENABLE_IP_MFC11, 4, CLK_IGNORE_UNUSED, 0),
...
#if defined(CONFIG_EXYNOS5430_HD)
	CGTE(gate_lite_b, "gate_lite_b", NULL, EXYNOS5430_ENABLE_IP_CAM00, 1, 0, 0),
#else
	...
	/* clk_out */
	CGTE(gate_clkout, "gate_clkout", "fin_pll", EXYNOS_PMU_DEBUG, 0, 0, CLK_GATE_SET_TO_DISABLE),
};
...
void show_exynos_cmu(void)
{
	...
	EXYNOS5430_PRINT_CMU(MEM0_PLL_CON0);
	EXYNOS5430_PRINT_CMU(MEM1_PLL_CON0);
	EXYNOS5430_PRINT_CMU(BUS_PLL_CON0);
	EXYNOS5430_PRINT_CMU(MFC_PLL_CON0);
	EXYNOS5430_PRINT_CMU(ISP_PLL_CON0);
	EXYNOS5430_PRINT_CMU(AUD_PLL_CON0);
	EXYNOS5430_PRINT_CMU(SRC_SEL_TOP0);
	EXYNOS5430_PRINT_CMU(SRC_SEL_TOP1);
	EXYNOS5430_PRINT_CMU(SRC_SEL_TOP2);
	EXYNOS5430_PRINT_CMU(SRC_SEL_TOP3);
	EXYNOS5430_PRINT_CMU(SRC_SEL_TOP4);
	EXYNOS5430_PRINT_CMU(DIV_TOP0);
	EXYNOS5430_PRINT_CMU(DIV_TOP1);
	EXYNOS5430_PRINT_CMU(DIV_TOP2);
	EXYNOS5430_PRINT_CMU(DIV_TOP3);
	EXYNOS5430_PRINT_CMU(DIV_TOP4);
	EXYNOS5430_PRINT_CMU(SRC_SEL_MIF0);
	pr_info(" -----------------------------------------------------------------------------------\n");
}
...
void __init exynos5430_clk_init(struct device_node *np)
{
...
#ifdef CONFIG_EXYNOS5430_HD
	set_pll35xx_ops(mem0_pll, FULL_PLL_OPS);
#endif
	...
	set_pll35xx_ops(mphy_pll, FULL_PLL_OPS);
