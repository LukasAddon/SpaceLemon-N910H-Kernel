...
struct samsung_fixed_rate_clock exynos5433_fixed_rate_clks[] __initdata = {
	...
	CFRATE(phyclk_mipidphy1_rxclkesc0_phy, NULL, CLK_IS_ROOT, 10000000),
	CFRATE(phyclk_mipidphy1_bitclkdiv8_phy, NULL, CLK_IS_ROOT, 188000000),
#else
...
struct samsung_gate_clock exynos5433_gate_clks[] __initdata = {
	...
	/* CLKOUT */
	CGTE(clkout, "clk_out", "fin_pll", EXYNOS_PMU_DEBUG, 0, 0, CLK_GATE_SET_TO_DISABLE),
...
#ifdef CONFIG_EXYNOS_DECON_DUAL_DISPLAY
	CGTE(gate_decon_tv, "gate_decon_tv", NULL, EXYNOS5430_ENABLE_IP_DISP0, 3, CLK_IGNORE_UNUSED, 0),
#else
...
#ifdef CONFIG_EXYNOS_DECON_DUAL_DISPLAY
	CGTE(gate_decontv_eclk, "gate_decontv_eclk", NULL, EXYNOS5430_ENABLE_IP_MIF3, 7, CLK_IGNORE_UNUSED, 0),
...
#ifdef CONFIG_EXYNOS_DECON_DUAL_DISPLAY
	CGTE(gate_decontv_vclk, "gate_decontv_vclk", NULL, EXYNOS5430_ENABLE_IP_MIF3, 10, CLK_IGNORE_UNUSED, 0),
	CGTE(gate_dsim1_clk, "gate_dsim1_clk", NULL, EXYNOS5430_ENABLE_IP_MIF3, 11, CLK_IGNORE_UNUSED, 0),
#else
	...
	/* DISP */
#ifdef CONFIG_EXYNOS_DECON_DUAL_DISPLAY
	CGTE(sclk_decon_tv_vclk_disp, "sclk_decon_tv_vclk_disp", "dout_sclk_decon_tv_vclk", EXYNOS5430_ENABLE_SCLK_MIF, 14, CLK_IGNORE_UNUSED, 0),
	CGTE(sclk_decon_tv_vclk, "sclk_decon_tv_vclk", "dout_sclk_decon_tv_vclk_disp", EXYNOS5430_ENABLE_SCLK_DISP, 21, CLK_IGNORE_UNUSED, 0),
	CGTE(sclk_dsim1_disp, "sclk_dsim1_disp", "dout_sclk_dsim1", EXYNOS5430_ENABLE_SCLK_MIF, 15, CLK_IGNORE_UNUSED, 0),
#else
	...
	/* AUD */
	CGTE(atclk_aud, "atclk_aud", "dout_atclk_aud", EXYNOS5430_ENABLE_SCLK_AUD0, 2, 0, 0),
};
